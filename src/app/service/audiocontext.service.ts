...
export class AudiocontextService {
  ...
  // private _beatsPerLoop = 4;
  // private _beatResolution = 16;
  ...
  // public get beatResolution() {
  //   return this._beatResolution;
  // }
  // public set beatResolution(newResolution) {
  //   if (this._isPlaying) {
  //     this.stop();
  //   }
  //   this._beatResolution = newResolution;
  // }
  ...
  // public get timePerLoop() {
  //   return this.timePerBeat*this._beatsPerLoop;
  // }
